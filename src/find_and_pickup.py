...
class Find_and_Pickup:
    def __init__(
        self,
        ball_finder: Ball_Finder_Machine,
        kuboki_controller: Kobuki,
        turn_limit: float,
    ):
...
class Super_Machine:
    ...
    def __init__(self) -> None:
        ...
        self.find_and_drop_squares = Find_and_Pickup(
            self.ball_finder_for_square, self.kuboki, 0.1
        )
        self.Time = 0
